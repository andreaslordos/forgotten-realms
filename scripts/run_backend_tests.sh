...
python3 -m coverage run --source=backend --omit='*/tests/*,backend/socket_server.py,backend/event_handlers.py,backend/managers/village_generator.py,backend/managers/village_generator_backup.py,backend/managers/world/*' -m unittest discover -s backend -p 'test_*.py'
