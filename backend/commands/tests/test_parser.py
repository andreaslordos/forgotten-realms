...
class ParseCommandWrapperBasicTest(unittest.TestCase):
    ...
    def test_parse_command_wrapper_returns_empty_list_for_empty_string(self, mock_vocab, mock_parse):
    ...
    @patch('commands.parser.parse_command')
    @patch('commands.parser.vocabulary_manager')
    def test_parse_command_wrapper_returns_empty_list_for_whitespace(self, mock_vocab, mock_parse):
    ...
    @patch('commands.parser.parse_command')
    @patch('commands.parser.vocabulary_manager')
    def test_parse_command_wrapper_calls_natural_language_parser(self, mock_vocab, mock_parse):
        ...
        # Act
        result = parse_command_wrapper("look", context=context, online_sessions={})
    ...
    @patch('commands.parser.parse_command')
    @patch('commands.parser.vocabulary_manager')
    def test_parse_command_wrapper_adds_context_to_commands(self, mock_vocab, mock_parse):
        ...
        # Act
        result = parse_command_wrapper("look", players_in_room=players_in_room, online_sessions=online_sessions)
    ...
    def test_parse_command_wrapper_handles_direct_player_message(self):
        ...
        online_sessions = {
            "sid1": {
                ...
                "temp_data": {"username": "Bob"}
            }
        }

        # Act
        result = parse_command_wrapper("Bob Hello there", online_sessions=online_sessions)
...
class ParseCommandWrapperMovementTest(unittest.TestCase):
    ...
    @patch('commands.parser.parse_command')
    def test_parse_command_wrapper_marks_movement_commands(self, mock_parse, mock_is_movement, mock_vocab):
    ...
    @patch('commands.parser.vocabulary_manager')
    @patch('commands.parser.parse_command')
    def test_parse_command_wrapper_creates_default_movement_command(self, mock_parse, mock_vocab):
...
class ParseCommandWrapperFallbackTest(unittest.TestCase):
    ...
    @patch('commands.parser.vocabulary_manager')
    @patch('commands.parser.parse_command')
    def test_parse_command_wrapper_creates_default_command_when_parser_fails(self, mock_parse, mock_vocab):
    ...
    @patch('commands.parser.vocabulary_manager')
    @patch('commands.parser.parse_command')
    def test_parse_command_wrapper_expands_abbreviated_verbs(self, mock_parse, mock_vocab):
    ...
    @patch('commands.parser.vocabulary_manager')
    @patch('commands.parser.parse_command')
    def test_parse_command_wrapper_includes_subject_in_fallback(self, mock_parse, mock_vocab):
...
class ParseCommandWrapperContextTest(unittest.TestCase):
    ...
    @patch('commands.parser.vocabulary_manager')
    def test_parse_command_wrapper_sets_mob_manager_from_context(self, mock_vocab, mock_nlp, mock_parse):
    ...
    @patch('commands.parser.parse_command')
    @patch('commands.parser.vocabulary_manager')
    def test_parse_command_wrapper_extracts_player_from_context_dict(self, mock_vocab, mock_parse):
