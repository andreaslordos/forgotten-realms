...
async def handle_help(
    ...
    help_text = (
        ...
        "MAGIC:\n"
        "  spells                       - List your spells and success chances.\n"
        "  bolt <target>                - Hurl raw force; resisted by magic, never dodged.\n"
        "  blind/cripple/sleep <target> - Afflict a player or monster (see 'spells').\n"
        "  Casting in combat costs stamina and your next swing.\n\n"
        "SHOPS & GOLD:\n"
        "  list                         - See a shopkeeper's wares and your gold.\n"
        "  buy <item>                   - Buy from a shopkeeper.\n"
        "  sell <item>                  - Sell goods for half their value.\n"
        "  drink <potion>               - Drink a potion (works mid-combat; also: quaff).\n"
        "  Coins convert to gold when picked up. Gold is lost on death.\n\n"
        "REST:\n"
        ...
        "  time                         - Show the time of day (night is dangerous).\n"
